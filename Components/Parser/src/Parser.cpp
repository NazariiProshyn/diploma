    ...
    else if (scope.top() == NMWidgets::button)
    {
        ...
        if (activeString == "clickable")
        {
            if (checkBool(valueString))
            {
                if (getBool(valueString))
                {
                    form.buttons[form.buttons.size() - 1].setclickable(true);
                }
                else
                {
                    form.buttons[form.buttons.size() - 1].setclickable(false);
                }
            }
            else
            {
        ...
        if (activeString == "doubleClickable")
        {
            if (checkBool(valueString))
            {
                if (getBool(valueString))
                {
                    form.buttons[form.buttons.size() - 1].setDoubleclickable(true);
                }
                else
                {
                    form.buttons[form.buttons.size() - 1].setDoubleclickable(false);
                }
            }
            else
            {
    ...
    else if (scope.top() == NMWidgets::numberBox)
    {
        ...
        if (activeString == "clickable")
        {
            if (checkBool(valueString))
            {
                if (getBool(valueString))
                {
                    form.numberBoxes[form.numberBoxes.size() - 1].setclickable(true);
                }
                else
                {
                    form.numberBoxes[form.numberBoxes.size() - 1].setclickable(false);
                }
            }
            else
            {
    ...
    else if (scope.top() == NMWidgets::checkBox)
    {
        ...
        if (activeString == "clickable")
        {
            if (checkBool(valueString))
            {
                if (getBool(valueString))
                {
                    form.checkBoxes[form.checkBoxes.size() - 1].setclickable(true);
                }
                else
                {
                    form.checkBoxes[form.checkBoxes.size() - 1].setclickable(false);
                }
            }
            else
            {
